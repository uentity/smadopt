...
public:
	...
	typedef Ialg_options *const const_iopt_ptr;
...
public:
	...
	virtual iopt_ptr get_wrapper_opt() const = 0;
	...
	void add_def_embopt(const_iopt_ptr iop, bool apply_defaults = true);
...
protected:
	...
	virtual void set_embopt_def(iopt_ref iopt) {};
	//delegates for reaction in derived classes
...
public:
	...
	data_opt *const get_data_opt() {
		return (data_opt*)this;
		//return &opt_;
	}

	virtual iopt_ptr get_wrapper_opt() const {
